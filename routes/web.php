...
Route::delete('/delete-all-doctors', [DoctorController::class, 'deleteAllDoctors'])->name('deleteAllDoctors');
// Route::get('/add-two-doctors', [DoctorController::class, 'addTwoDoctors'])->name('addTwoDoctors');
Route::post('/add-two-doctors', [DoctorController::class, 'addTwoDoctors'])->name('addTwoDoctors');
Route::get('/records', [DoctorController::class, 'records'])->name('records');
Route::post('/export', [DoctorController::class, 'exportToExcel'])->name('exportToExcel');
